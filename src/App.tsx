    ...
    <div className="w-full min-h-screen bg-gray-900 flex justify-center px-4">
      <main className="my-10 w-full md:max-w-2x1">
        ...
        <form className="flex flex-col my-6" onSubmit={handleSubmit}>
          ...
          <input type="text" placeholder="Enter your name..." className="w-full mb-5 p-2 rounded" ref={nameRef}/>

          <label className="font-medium text-white">Email:</label>
          <input type="email" placeholder="Enter your email..." className="w-full mb-5 p-2 rounded" ref={emailRef}/>

          <input type="submit" value="Register" className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />
        </form>
